        ...
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    <li>
                        <a href="{{url('/Kurir/Home')}}">
                            <i class="iconsminds-home"></i> Home
                        </a>
                    </li>   
                    <li>
                        <a href="{{url('/Kurir/Paket/AkanDikirim')}}">
                            <i class="glyph-icon simple-icon-handbag"></i>Akan Dikirim
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/Kurir/Paket/SedangDikirim')}}">
                            <i class="glyph-icon simple-icon-handbag"></i>Sedang Dikirim
                        </a>
                    </li>   
                    <li>
                        <a href="{{url('/Kurir/Paket/SelesaiDikirim')}}">
                            <i class="glyph-icon simple-icon-handbag"></i>Selesai Dikirim
                        </a>
                    </li>                                                             
                </ul>
            </div>
