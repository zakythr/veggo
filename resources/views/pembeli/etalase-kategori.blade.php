...
<div class="container-fluid disable-text-selection">
    <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <select onChange="window.location.href=this.value" id="inputState" class="form-control" name="tanggal_pre_order">
                        ...
                        <option value="{{url('Pembeli/Etalase/LihatProduk/'.$data['nama_kategori'].'/'.$data['nama_subproduk'].'/'.$pengiriman->tanggal_value)}}" selected>{{$pengiriman->tanggal}}</option>    
                        @else
                        <option value="{{url('Pembeli/Etalase/LihatProduk/'.$data['nama_kategori'].'/'.$data['nama_subproduk'].'/'.$pengiriman->tanggal_value)}}">{{$pengiriman->tanggal}}</option>
                        @endif
        ...
        <div class="col-12">
            <div class="mb-2">
                <h1>Semua Produk {{ $data['nama_subproduk'] }}</h1>
            </div>
            <div class="mb-2">
                ...
                {{-- <div class="collapse d-md-block" id="displayOptions">
                    ...
                    <div class="float-md-right">
                        <span class="text-muted text-small">Menampilkan {{sizeof($data['barang'])}} Produk</span>
                    </div>
                </div> --}}
            </div>
    ...
    {{-- <h1>{{$item[0]['subkategori']}}</h1> --}}
    {{-- @foreach ($data['barang'] as $key => $item)
    <h1>{{$item['subkategori'][0]->sub_kategori}}</h1> --}}
        {{-- <div class="col-12">
            <div class="row">
                <div class="col-12">
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="collapse d-md-block" id="displayOptions">
                            ...
                            <div class="float-md-right">
                                <span class="text-muted text-small">Menampilkan {{count($item['barang']) }} Produk</span>
                            </div>
                        </div>
                    </div>
                    <div class="separator mb-5"></div>
                        ...
                        <div class="card d-flex flex-row mb-3">
                            ...
                            <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                                <div
                                    ...
                                    <a href="{{url('Pembeli/Etalase/Detail/'.$barang->id)}}" class="w-40 w-sm-100">
                                    ...
                                    <div class="w-15 w-sm-100">
                                @if($barang->ketersediaan != 0)
                                    <button class="btn btn-xs btn-success" style="color:white;" onclick="tambahItem('{{$barang->id}}')" data-toggle="modal" data-target="#itemModal">Tambah</button>                                    
                                @else
