            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <select onChange="window.location.href=this.value" id="inputState" class="form-control" name="tanggal_pre_order">
                        ...
                        <option value="{{url('Pembeli/Etalase/CariProduk/'.$data['pencarian_produk'].'/'.$pengiriman->tanggal_value)}}" selected>{{$pengiriman->tanggal}}</option>    
                        @else
                        <option value="{{url('Pembeli/Etalase/CariProduk/'.$data['pencarian_produk'].'/'.$pengiriman->tanggal_value)}}">{{$pengiriman->tanggal}}</option>
                        @endif
