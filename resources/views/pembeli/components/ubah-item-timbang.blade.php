...
<br>
<div align="center">
    <button id="tambahh" class="btn btn-success" onclick="submitUbahItem('{{ $data['barang']->id }}')" disabled>Ubah Keranjang</button>
</div>
...
<script>  
    ...
    $('input:radio[id="lainnya"]').on('change', function() {
        ...
        if(volume_orderr==null || volume_orderr=="" || volume_orderr < 100 ){
            document.getElementById("tambahh").disabled = true;
        }
        else{
            document.getElementById("tambahh").disabled = false;
