...
@section('content')
<form method="POST" action="{{ url('/Pembeli/Checkout/Purchase') }}">
    @csrf
    <div class="form-group">
        <input hidden name="tanggal_pre_order" value="{{$data['keranjang']->tanggal_pre_order}}">
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="alert alert-success" role="alert">
                    <a href="/Pembeli/TambahAlamat">Penambahan Alamat dapat dilakukan di halaman <b>ini</b></a>
                </div>
                <hr>
                <div class="mb-4">
                                ...
                                <div class="col-6">
                                    <a href="#">
                                        @if($keranjang->diskon>0)
                                            ...
                                            <p class="list-item-heading mb-1 color-theme-1">{{ $keranjang->nama }} ( diskon {{ "Rp " . number_format(($keranjang->diskon/1000)*$keranjang->bobot_kemasan,0,',','.') }} )</p>
                                            @else
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="#">
                                    @if($keranjang->diskon>0)
                                        @if($keranjang->diskon>100)
                                        <p class="list-item-heading mb-1 color-theme-1">{{ $keranjang->nama }} ( diskon {{ "Rp " . number_format(($keranjang->diskon/1000)*$keranjang->volume,0,',','.') }} )</p>
                                        @else
                                        <p class="list-item-heading mb-1 color-theme-1">{{ $keranjang->nama }} ( diskon {{$keranjang->diskon}}% )</p>
                                        @endif
                                    @else
