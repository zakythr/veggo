        ...
        <div class="main-menu">
            <div class="scroll" style="background-color: #99e265">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="{{ url('Pembeli/Profil') }}">
                            <i class="iconsminds-male-female d-block"></i> Profil Akun
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('Pembeli/LihatAlamat/'.Auth::user()->id)}}">
                            <i class="iconsminds-puzzle d-block"></i> Alamat
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('Pembeli/Transaksi/Tipe/BelumDibayar')}}">
                            <i class="iconsminds-bar-chart-4 d-block"></i> Transaksi
                        </a>
                    </li>
                    <li>
                        <a href="https://wa.me/087780402785">
                            <i class="iconsminds-file d-block"></i> Komplain
                        </a>
                    </li>
                </ul>
            </div>
