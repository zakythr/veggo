...
<body id="app-container" class="menu-default show-spinner">
    <nav class="navbar fixed-top" style="background-color: #99e265">
        <div class="d-flex align-items-center navbar-left">
            ...
            <div class="search" data-search-path="{{url('/Pembeli/Etalase/CariProduk').'/'}}">
    ...
    <div class="sidebar">
        <div class="main-menu">
            <div class="scroll" style="background-color: #99e265">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="#bahanolahan">
                            <i class="iconsminds-can"></i> Daging dan Telor
                        </a>
                    </li>   
                    <li>
                        <a href="#beras">
        ...
        <div class="sub-menu">
            <div class="scroll">
                <ul class="list-unstyled" data-link="buah">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Buah')}}">
                            <span class="d-inline-block">Semua Buah</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['buah'] as $buah)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Buah/'.$buah->sub_kategori)}}">
                            <span class="d-inline-block">{{$buah->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach
                </ul>
                <ul class="list-unstyled" data-link="sayur">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Sayur')}}">
                            <span class="d-inline-block">Semua Sayur</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['sayur'] as $sayur)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Sayur/'.$sayur->sub_kategori)}}">
                            <span class="d-inline-block">{{$sayur->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach                    
                </ul>
                <ul class="list-unstyled" data-link="makanansehat">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Makanan Sehat')}}">
                            <span class="d-inline-block">Semua Makanan Sehat</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['makanansehat'] as $makanansehat)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Makanan Sehat/'.$makanansehat->sub_kategori)}}">
                            <span class="d-inline-block">{{$makanansehat->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach                    
                </ul>
                <ul class="list-unstyled" data-link="minumansehat">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Minuman Sehat')}}">
                            <span class="d-inline-block">Semua Minuman Sehat</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['minumansehat'] as $minumansehat)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Minuman Sehat/'.$minumansehat->sub_kategori)}}">
                            <span class="d-inline-block">{{$minumansehat->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach                    
                </ul>
                <ul class="list-unstyled" data-link="bahanolahan">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Bahan Daging dan Telor')}}">
                            <span class="d-inline-block">Semua Daging dan Telor</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['bahanolahan'] as $bahanolahan)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Daging dan Telor/'.$bahanolahan->sub_kategori)}}">
                            <span class="d-inline-block">{{$bahanolahan->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach                    
                </ul>         
                <ul class="list-unstyled" data-link="beras">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Beras')}}">
                            <span class="d-inline-block">Semua Beras</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['beras'] as $beras)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Beras/'.$beras->sub_kategori)}}">
                            <span class="d-inline-block">{{$beras->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach                    
                </ul>                  
                <ul class="list-unstyled" data-link="berkebun">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Berkebun')}}">
                            <span class="d-inline-block">Semua Berkebun</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['berkebun'] as $berkebun)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Berkebun/'.$berkebun->sub_kategori)}}">
                            <span class="d-inline-block">{{$berkebun->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach                    
                </ul>                                                                
                <ul class="list-unstyled" data-link="lainlain">
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduks/Lain - Lain')}}">
                            <span class="d-inline-block">Semua Lain - Lain</span>
                        </a>
                    </li>
                    @foreach($data['kategori']['lainlain'] as $lainlain)
                    <li>
                        <a href="{{url('/Pembeli/Etalase/LihatProduk/Lain - Lain/'.$lainlain->sub_kategori)}}">
                            <span class="d-inline-block">{{$lainlain->sub_kategori}}</span>
                        </a>
                    </li>
                    @endforeach                    
                </ul>                                  
