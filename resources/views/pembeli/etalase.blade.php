            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <select onChange="window.location.href=this.value" id="inputState" class="form-control" name="tanggal_pre_order">
                        <option value="kosong" disabled selected>Pilih Tanggal Kirim</option>
                        @foreach($data['tanggal_pengiriman'] as $pengiriman)
                        @if ($data['tanggal']==$pengiriman->tanggal_value)
                        <option value="{{url('Pembeli/Etalase/'.$pengiriman->tanggal_value)}}" selected>{{$pengiriman->tanggal}}</option>    
                        @else
                        <option value="{{url('Pembeli/Etalase/'.$pengiriman->tanggal_value)}}">{{$pengiriman->tanggal}}</option>
                        @endif
                        @endforeach
                    </select>
                </div>
