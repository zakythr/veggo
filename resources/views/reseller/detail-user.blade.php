        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <p class="text-muted text-small mb-2">Nama Pembeli Offline</p>
                    <p class="mb-3">{{$data['dataPembeli']->name}}</p>
                    <p class="text-muted text-small mb-2">Alamat</p>
                    <p class="mb-3">{{$data['dataPembeli']->alamat}}</p>
                    <p class="text-muted text-small mb-2">Nomor Telepon</p>
                    <p class="mb-3">{{$data['dataPembeli']->nohp}}</p>
