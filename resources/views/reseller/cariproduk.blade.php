...
<div class="container-fluid disable-text-selection">
    <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <select onChange="window.location.href=this.value" id="inputState" class="form-control" name="tanggal_pre_order">
                        ...
                        <option value="{{url('Reseller/Etalase/CariProduk/'.$data['pencarian_produk'].'/'.$pengiriman->tanggal_value)}}" selected>{{$pengiriman->tanggal}}</option>    
                        @else
                        <option value="{{url('Reseller/Etalase/CariProduk/'.$data['pencarian_produk'].'/'.$pengiriman->tanggal_value)}}">{{$pengiriman->tanggal}}</option>
                        @endif
        ...
        <div class="col-12">
            <div class="mb-2">
                <h1>Hasil Pencarian "{{ $data['pencarian_produk'] }}"</h1>
            </div>
