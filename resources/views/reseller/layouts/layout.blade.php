...
<body id="app-container" class="menu-default show-spinner">
    <nav class="navbar fixed-top" style="background-color: #99e265">
        <div class="d-flex align-items-center navbar-left">
            ...
            <div class="search" data-search-path="{{url('/Reseller/Etalase/CariProduk').'/'}}">
            ...
            @else
                ...
                <div class="user d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right mt-3">
                        ...
                        @endif
                        <a class="dropdown-item" href="{{ url('/Reseller/Profil') }}">Profil Akun</a>
        ...
        <div class="main-menu">
            <div class="scroll" style="background-color: #99e265">
                <ul class="list-unstyled">
                    <li>
                        <a href="{{url('Reseller/Etalase')}}">
                            <i class="iconsminds-home"></i> Etalase
                        </a>
                    </li>                                                                        
                    <li>
                        <a href="{{ url('Reseller/Transaksi/Tipe/BelumDibayar')}}">
                            <i class="iconsminds-bar-chart-4 d-block"></i> Transaksi
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('Reseller/User/'.Auth::user()->id.'/'.date('Y-m-d'))}}">
                            <i class="iconsminds-male-female d-block"></i> Pembeli Offline
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('Reseller/LihatAlamat/'.Auth::user()->id)}}">
                            <i class="iconsminds-male-female d-block"></i> Alamat
                        </a>
                    </li>
                </ul>
            </div>
